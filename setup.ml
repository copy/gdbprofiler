...
(* OASIS_START *)
(* DO NOT EDIT (digest: 57fde54ad54ca3c4f63910ee4434d304) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("ppx_tools", None)];
                   ...
                   {exec_custom = false; exec_main_is = "ppx_inject.ml"});
               Library
                 ({
                     cs_name = "gdb";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some ",\236\231\\\202`]\198\140\197\25294F\173\217";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
