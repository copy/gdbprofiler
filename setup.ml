...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0160bccdcab9a7c5e416a582356db715) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["copy"];
          homepage = Some "https://github.com/copy/gdbprofiler";
          bugreports = None;
          synopsis = "A profiler for native binaries using gdb";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "rmp"];
                      bs_interface_patterns =
                        [
                           {
                              OASISSourcePatterns.Templater.atoms =
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "3\165QL\1399\019\n\245\021\150\204CN\232U";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
