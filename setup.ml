...
(* OASIS_START *)
(* DO NOT EDIT (digest: 931e46f332c831b28dd1d329e63248a9) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["ygrek"];
          homepage = Some "https://github.com/ygrek/ocaml-gdb";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "GDB/MI allows to programmatically control GNU debugger, useful application being a stack-sampling profiler."
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Gdb"; "Gdbmi_types"; "Gdbmi_proto"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Gdbmi_parser"; "Gdbmi_lexer"; "Gdbmi_utils"];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Callgrind"; "Cpuprofile"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "gdb"; InternalLibrary "rmp_lib"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "rmp.ml"});
               Executable
                 ({
                     cs_name = "run_integration_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [FindlibPackage ("containers", None)];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; InternalExecutable "rmp"];
                      bs_interface_patterns =
                        [
                           {
                              OASISSourcePatterns.Templater.atoms =
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "run_integration_test.ml"
                   });
               Executable
                 ({
                     cs_name = "run_unit_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "run_unit_test.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\127\203\196v\248\216\178k\138M\239\184o>~\244";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
